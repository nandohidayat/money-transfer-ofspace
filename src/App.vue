...
<template>
  <div class="flex min-h-screen w-full bg-gray-700 font-sans">
    ...
    <aside class="flex w-64 flex-col px-4 pt-10 pb-6">
      ...
      >
        <DashboardIcon class="h-6 w-6 stroke-current" /><span>Transfer</span>
      </a>
      <ul class="flex flex-1 flex-col gap-y-10 px-8 pt-14">
        <li v-for="item in menu">
          <a
            href="#"
            class="flex items-center gap-x-4 text-gray-400 hover:font-medium hover:text-white focus:font-medium focus:text-white"
          >
    ...
    >
          ...
          <div class="flex items-center gap-x-2">
            <div class="relative">
              ...
              <input
                type="text"
                placeholder="Search"
                class="rounded-10 bg-gray-900 py-3 pl-10 pr-4 text-sm text-gray-400 focus:text-white focus:outline-none"
              />
            </div>
            <button
          ...
          <div class="flex items-center gap-x-2.5">
            ...
            >
              ...
              <div class="absolute top-3 right-3 flex h-2 w-2">
                <span
                  class="inline-flex h-2 w-2 rounded-full bg-indigo-400"
                ></span>
              </div>
            </button>
            <button
      ...
      <div class="flex gap-x-6 py-8">
        <div class="flex w-3/5 flex-col gap-y-8">
          <!-- Card Detail -->
          <div
            class="flex items-center justify-between rounded-10 bg-gray-900 bg-[url(/img/line-pattern.svg)] p-6"
          >
          ...
          <!-- Statistic of Costs -->
          <div class="flex flex-col justify-between rounded-10 bg-gray-900 p-6">
          ...
          <div class="flex flex-col justify-between rounded-10 bg-gray-900 p-6">
            ...
            <table class="mt-4 border-separate" id="invoice-table">
              <thead>
                <tr>
                  <td class="py-1 pl-4 text-sm text-gray-400">No</td>
                  ...
                  <td class="py-1 pr-4 text-sm text-gray-400">Status</td>
                </tr>
              </thead>
              <tbody>
                <tr v-for="invoice in invoices" class="rounded-10 bg-gray-700">
                  <td class="rounded-tl-10 rounded-bl-10 py-4 pl-4">
                  ...
                  <td class="py-4">
                    <div class="flex items-center gap-x-2">
                      ...
                      />
                      <span class="text-sm text-white">{{ invoice.name }}</span>
                    </div>
                  </td>
                  <td class="py-4">
                    <span class="text-sm text-white">{{ invoice.amount }}</span>
                  </td>
                  <td class="rounded-tr-10 rounded-br-10 py-4 pr-4">
                    <div
                      class="flex items-center justify-center gap-x-2 rounded-10 border py-2 px-1"
                      :class="
                        invoice.status === 'Successful'
                          ? 'border-green-400/20 bg-green-700/20 text-green-400'
                          : 'border-indigo-400/20 bg-indigo-700/20 text-indigo-400'
                      "
                    >
                      <span
        ...
        <div class="flex w-2/5 flex-col gap-y-8">
          ...
          <div class="flex flex-col justify-between rounded-10 bg-gray-900 p-6">
            ...
            <div class="flex flex-col gap-y-4 pt-4">
              ...
              >
                <div
                  class="flex items-center justify-center rounded-full bg-indigo-400 p-2"
                >
                  <InvestmentIcon class="h-5 w-5 fill-current" />
                </div>
                <div class="flex-1">
                  ...
                  <span class="text-sm leading-3 text-gray-400"
                    >2 months income 80%</span
                  >
                  <div class="mt-3 h-2 w-full rounded-full bg-gray-900">
                    <div class="h-2 w-4/5 rounded-full bg-indigo-400"></div>
                  </div>
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  <FundIcon class="h-5 w-5 fill-current" />
                </div>
                <div class="flex-1">
                  <div class="flex items-center justify-between leading-none">
                  ...
                  <span class="text-sm leading-3 text-gray-400"
                    >4 months income 50%</span
                  >
                  <div class="mt-3 h-2 w-full rounded-full bg-gray-900">
                    <div class="h-2 w-1/2 rounded-full bg-green-400"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="flex flex-col justify-between rounded-10 bg-gray-900 p-6">
            ...
            <div class="flex items-center gap-x-4 pt-4">
              <div class="rounded-10 bg-gray-700 p-4"><DoughnutChart /></div>
              <div class="flex flex-1 flex-col gap-4">
                ...
                >
                  ...
                  <div>
                    <div class="text-sm text-indigo-700">Mutual Funds</div>
                    <div class="font-normal">$10,567</div>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div>
                    <div class="text-sm text-green-700">Investment</div>
                    <div class="font-normal">$8,567</div>
                  </div>
                </div>
              </div>
